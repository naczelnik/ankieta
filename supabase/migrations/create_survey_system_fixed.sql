/*
  # System Ankiet - Schemat Bazy Danych (Poprawiony)
...
-- Usunięcie istniejących polityk przed utworzeniem nowych
DROP POLICY IF EXISTS "Użytkownicy mogą przeglądać swoje ankiety" ON surveys;
DROP POLICY IF EXISTS "Użytkownicy mogą tworzyć ankiety" ON surveys;
DROP POLICY IF EXISTS "Użytkownicy mogą aktualizować swoje ankiety" ON surveys;
DROP POLICY IF EXISTS "Użytkownicy mogą usuwać swoje ankiety" ON surveys;
DROP POLICY IF EXISTS "Publiczny dostęp do aktywnych ankiet" ON surveys;
DROP POLICY IF EXISTS "Właściciele ankiet mogą przeglądać odpowiedzi" ON survey_responses;
